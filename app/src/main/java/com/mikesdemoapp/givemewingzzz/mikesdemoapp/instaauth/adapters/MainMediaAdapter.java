package com.mikesdemoapp.givemewingzzz.mikesdemoapp.instaauth.adapters;
...
import com.mikesdemoapp.givemewingzzz.mikesdemoapp.instaauth.customviews.RoundedImageView;
...
public class MainMediaAdapter extends RealmBaseRecyclerViewAdapter<UserFollows, MainMediaAdapter.UserSearchViewHolder> {
    ...
    public static class UserSearchViewHolder extends RecyclerView.ViewHolder {
        ...
        UserSearchViewHolder(View itemView) {
            super(itemView);
            user_header = (TextView) itemView.findViewById(R.id.user_header);
