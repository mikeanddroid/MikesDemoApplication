package com.mikesdemoapp.givemewingzzz.mikesdemoapp.mapsclusterdemo.base;
...
import com.mikesdemoapp.givemewingzzz.mikesdemoapp.mapsclusterdemo.service.ApiCall.FetchSearchedLocations;
import com.mikesdemoapp.givemewingzzz.mikesdemoapp.mapsclusterdemo.service.OttoHelper;
import com.mikesdemoapp.givemewingzzz.mikesdemoapp.mapsclusterdemo.ui.ClusterMapFragment;
import com.mikesdemoapp.givemewingzzz.mikesdemoapp.mapsclusterdemo.ui.MapListFragment;
...
public class MapsClusterActivity extends AppCompatActivity implements View.OnClickListener, MaterialSearchBar.OnSearchActionListener, PopupMenu.OnMenuItemClickListener {

    private static final String TAG = MapsClusterActivity.class.getSimpleName();
                ...
                if (s.length() >= 4) {
                    ...
                    FetchSearchedLocations.call(s.toString().trim(), new FetchSearchedLocations.OnResultsComplete() {
                        ...
                        public void onResultsQueryLimit(String errorMessage) {
                            ...
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MapsClusterActivity.this);
...
//        clusterMapFragment.fetchMapData(successEvent.getBaseModel());
    ...
    public void onResultFailure(FetchSearchedLocations.SearchedFailureEvent failureEvent) {
        ...
        Toast.makeText(this, "MapsClusterActivity : Failed to retrieve data .. \n" + failureEvent.getErrorMessage(), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onSearchStateChanged(boolean enabled) {
        ...
        Toast.makeText(MapsClusterActivity.this, "Search " + s, Toast.LENGTH_SHORT).show();
    }
